                                ...
                                <div class="row push">
                                    ...
                                    <div class="col-lg-8 col-xl-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('nombre') is-invalid @enderror" id="nombre" name="nombre" placeholder="Nombre usuario" value="{{$users->name}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control @error('correo') is-invalid @enderror" id="correo" name="correo" placeholder="Correo usuario" value="{{$users->email}}">
